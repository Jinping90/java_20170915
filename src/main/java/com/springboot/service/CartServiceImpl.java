...
//        //使用迭代器的remove()方法删除元素
//        Iterator<Map.Entry<Products,Integer>> it = cart.entrySet().iterator();
//        while(it.hasNext()){
//            Map.Entry<Products,Integer> entry = it.next();
//            if(entry.getKey() == null){
//                it.remove();
//            } else if (entry.getKey().getProductId() == product.getProductId()){
//                it.remove();
//                break;
//            }
//
...
//        Map<Products,Integer> productsIntegerMap = cart; //用于测试
//        int i = 1;
        return cart;
    }
