...
<link href="http://fonts.googleapis.com/css?family=Great+Vibes%7CLato:100,100i,300,300i,400,400i,700,700i,900,900i" rel="stylesheet">
	...
	<script>
		...
		function delBuyNum(obj) {
			...
			top.location.href="editCartProduct.action?productId="+id+"&bnum="+num;
//			if(num > 0){
//				$(obj).next().val(num-1);
//			}
		}
							...
							<tbody>
								...
								<tr>
									<td colspan="5" class="actions">
										...
										<%--<input type="submit" class="update-cart" name="update_cart" value="刷新列表" />--%>
									</td>
								</tr>
							</tbody>
						</table>
