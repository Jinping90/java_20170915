...
<div class="site">
	...
	<div id="main">
		...
		<form onsubmit="return formObj.checkForm()" id="signupForm" name="form1" method="post" action="${ctx}/paymentMethod">
						...
						<br/>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="address">
										<select onblur="if(this.value.replace(/^ +| +$/g,'')=='')alert('不能为空!')" id="s_province" name="province"></select>
										<select onblur="if(this.value.replace(/^ +| +$/g,'')=='')alert('不能为空!')" id="s_city" name="city" ></select>
